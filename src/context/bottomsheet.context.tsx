import { createContext, FC, PropsWithChildren, use, useCallback, useContext, useRef, useState } from "react";
...
export const BottomSheetProvider: FC<PropsWithChildren> = ({ children }) => {
    ...
    const openBottomSheet = useCallback((newContent: React.ReactNode, index: number) => {
        ...
        setIsOpen(true);
        /**
         * Defini a altura que o bottom sheet deve abrir, e usei o requestAnimationFrame 
         * para garantir que a animação ocorra após a renderização do conteúdo.
         */
